...
//		dir = new CPMDirectory(); // 5 "DD disk
		dir = new CPMDirectory(bigDisk,maxEntries,sectorsPerBlock,bytesPerSector,trackOffset,maxBlocks); // 5 "DD disk
	}
	...
	public void testGetPhysicalSectorNumber() {
		for (int testEntryNumber = 0; testEntryNumber < 127; testEntryNumber++) {
			assertThat("getPhysicalSectorNumber - " + testEntryNumber, (testEntryNumber / entriesPerSector)+trackOffset ,
	...
	public void testConstructor(){
		...
		assertThat("testConstructor - 1C", maxEntries ,	equalTo(dir.getActiveEntryCount()+dir.getAvailableEntryCount()));	
	}
	@Test
	public void testAddDirectoryEntry(){
		...
		assertThat("testAddDirectoryEntry - 1C", maxBlocks ,	equalTo(dir.getAllocatedBlockCount()+dir.getAvailableBlockCount()));
		...
		int loc;
		 ...
		 blockCount = 1;
		 dirCount = 1;
		assertThat("testAddDirectoryEntry - 2B", maxBlocks-blockCount ,	equalTo(dir.getAvailableBlockCount()));
		assertThat("testAddDirectoryEntry - 2C", blockCount ,	equalTo(dir.getAllocatedBlockCount()));
		assertThat("testAddDirectoryEntry - 2D", maxBlocks ,	equalTo(dir.getAllocatedBlockCount()+dir.getAvailableBlockCount()));
		...
		assertThat("testAddDirectoryEntry - 2E", maxEntries -dirCount ,	equalTo(dir.getAvailableEntryCount()));
		 ...
		 blockCount = 2;
		 dirCount=2;
		assertThat("testAddDirectoryEntry - 3B", maxBlocks-blockCount ,	equalTo(dir.getAvailableBlockCount()));
		assertThat("testAddDirectoryEntry - 3C", blockCount ,	equalTo(dir.getAllocatedBlockCount()));
		assertThat("testAddDirectoryEntry - 3D", maxBlocks ,	equalTo(dir.getAllocatedBlockCount()+dir.getAvailableBlockCount()));
		assertThat("testAddDirectoryEntry - 2D", dirCount ,	equalTo(dir.getActiveEntryCount()));
		assertThat("testAddDirectoryEntry - 2E", maxEntries -dirCount ,	equalTo(dir.getAvailableEntryCount()));
		 ...
		 blockCount = 4;
		 dirCount=3;
		assertThat("testAddDirectoryEntry - 4B", maxBlocks-blockCount ,	equalTo(dir.getAvailableBlockCount()));
		assertThat("testAddDirectoryEntry - 4C", blockCount ,	equalTo(dir.getAllocatedBlockCount()));
		assertThat("testAddDirectoryEntry - 4D", maxBlocks ,	equalTo(dir.getAllocatedBlockCount()+dir.getAvailableBlockCount()));
		assertThat("testAddDirectoryEntry - 2D", dirCount ,	equalTo(dir.getActiveEntryCount()));
		assertThat("testAddDirectoryEntry - 2E", maxEntries -dirCount ,	equalTo(dir.getAvailableEntryCount()));
